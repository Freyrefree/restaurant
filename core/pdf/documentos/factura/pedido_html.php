...
<page backtop="28mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 18pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 14px;">
		<tr>
			...
			<td style="width:45%; ">
            <br />
                <?php  echo "<b>".date("d")."</b><b style='margin-left:90px;'>".date("m")."</b><b style='margin-left:170px;'>".date("y")."</b>"; ?><br><br />
				 <?php echo "<b>".$cliente->nombres."</b><b style='margin-left:400px;'>".$cliente->ruc."</b>"; ?><br><br />
                 <?php echo $cliente->direccion; ?><br> <br />
    ...
    <table cellspacing="0" style="width: 100%; border: solid 0px #7f8c8d; text-align: left; font-size: 14pt;padding:1mm; padding-left:-50px;padding-top:-10px;">
        <tr >
...
<tr>
	...
	<td style="width: 21% "><?php echo $operation->q ;?></td>
	<td style="width: 55%"><?php echo $product->name ;?></td>
	<td style="width: 14%"><?php echo $product->price_out ;?></td>
	<td style="width: 10%"><b>S/. <?php echo number_format($operation->q*$product->price_out);$total+=$operation->q*$product->price_out;?></b></td>
</tr>
...
<page_footer>
        <table class="page_footer" style="padding-bottom:490px;">
        	<tr>
            ...
            <tr>
	<td colspan="2" style="padding-left:40px;"><?php echo strtoupper(valorEnLetras(66.80)) ;?></td>
    <td></td>
	<td></td>
</tr>  
...
<tr>
    ...
    <td></td>
    <br />
	<td ><?php echo "<br>". number_format($total*0.18,2) ;?></td>
</tr>
