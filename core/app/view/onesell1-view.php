...
<h3>Cliente: <?php echo $cliente->nombres." ".$cliente->ruc; ?></h3>
...
<?php if($sell->is_applied):?>
<h4><a href="core/pdf/documentos/factura.php?id=<?php echo $_GET['id']; ?>" target="_blank" class="btn btn-warning"><i class="glyphicon glyphicon-print"></i> Imprimir Factura</a>
