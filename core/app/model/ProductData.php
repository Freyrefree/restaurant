...
class ProductData {
	...
	public function add(){
		$sql = "INSERT INTO ".self::$tablename." (code,codigoSAT,name,category_id,price_in,price_out,user_id,unit,duration,description,preparation,use_ingredient) ";
		$sql .= "VALUES (\"$this->code\",\"$this->codigoSAT\",\"$this->name\",\"$this->category_id\",\"$this->price_in\",\"$this->price_out\",$this->user_id,\"$this->unit\",\"$this->duration\",\"$this->description\",\"$this->preparation\",\"$this->use_ingredient\")";
...
// partiendo de que ya tenemos creado un objecto ProductData previamente utilizamos el contexto
	public function update($id){
		$sql = "update ".self::$tablename." set codigoSAT=\"$this->codigoSAT\", name=\"$this->name\",
		price_in=\"$this->price_in\",price_out=\"$this->price_out\",unit=\"$this->unit\",
		presentation=\"$this->presentation\",category_id=\"$this->category_id\",
		code=\"$this->code\",duration=\"$this->duration\",description=\"$this->description\",
		preparation=\"$this->preparation\",use_ingredient=\"$this->use_ingredient\" where id=$id";
		Executor::doit($sql);
	}
