...
// partiendo de que ya tenemos creado un objecto UserData previamente utilizamos el contexto
	public function update($id){
		$sql = "update ".self::$tablename." set name=\"$this->name\",email=\"$this->email\",image=\"$this->image\" where id= $id ";
		Executor::doit($sql);
	}
	...
	public function update_password($id){
		$sql = "update ".self::$tablename." set password=\"$this->password\" where id= $id ";
		Executor::doit($sql);
	}
	...
	// public static function getOneMesero(){

	// 	$sql = "SELECT * FROM ".self::$tablename." where is_mesero=1 AND id = ";
	// 	$query = Executor::doit($sql);
	// 	$array = array();
	// 	$cnt = 0;
